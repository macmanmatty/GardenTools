 ...
 *
 */
@Component("DaysBetweenYearly")
@Scope("prototype")

public class DaysBetweenYearly extends DailyAndMonthlyWeatherProcessor {
    /**
     * the counted hours
     */
    ...
    protected void onEndYear(Number value, LocalDateTime date) {
        String text="Days Between "+ lowerBound + " And "+upperBound +" Monthly "+" Of "+dataType;
