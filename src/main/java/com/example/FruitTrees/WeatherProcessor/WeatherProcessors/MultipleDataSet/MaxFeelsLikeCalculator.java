...
public class MaxFeelsLikeCalculator extends ProcessMultipleWeatherDataSetsBetweenDates {
    double feelsLike=Double.MIN_VALUE;
    public MaxFeelsLikeCalculator() {
    }
    @Override
    public void before() {
    ...
    protected void onEndDate(LocalDateTime localDateTime) {
        ...
        String text = "Max Feels Like  " + this.feelsLike;
        yearlyValuesResponse.getValues().put(text, String.valueOf(this.feelsLike));
        this.feelsLike = Double.MIN_VALUE;
    }
    @Override
